...
/****************************************************************************/
        case IPS_PATCHES:
            menu::stack_push<menu_ips_patches>(ui(), target());
            break;
/****************************************************************************/
...
/****************************************************************************/
		case AUTOFIRE:
			menu::stack_push<menu_autofire>(ui(), target());
			break;

		case CUSTOM_BUTTON_SETTING:
			menu::stack_push<menu_custom_setting>(ui(), target());		
			break;

		case CUSTOM_BUTTON:
			menu::stack_push<menu_custom_button>(ui(), target());		
			break;
/****************************************************************************/
...
{
	rgb_t const background_color = rgb_t(0xff, 0x00, 0x80, 0x40); 
