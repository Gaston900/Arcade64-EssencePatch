...
u8 pgm_028_025_state::source_data_r(u32 region, u8 addr)
{
	// tables are xored by table at $1998dc
	// tables are the same as drgw3 and drgw2
	static constexpr u8 source_data[8][0xec] = // table addresses $2951CA
	{
		{ // region 0, unused...
			0,
		},
	...
	return (region < 8) ? source_data[region][addr] : 0;
}
...
void pgm_028_025_state::machine_reset()
{
	...
	m_igs025->set_game_id(0x00900000 | region);
...
void pgm_028_025_state::init_olds()
{
	...
	m_maincpu->space(AS_PROGRAM).install_readwrite_handler(0xdcb400, 0xdcb403, read16sm_delegate(*m_igs025, FUNC(igs025_device::prot_r)), write16sm_delegate(*m_igs025, FUNC(igs025_device::olds_w)));
}
...
void pgm_028_025_state::olds_mem(address_map &map)
{
	...
	map(0x400000, 0x403fff).ram().share("igs028:sharedprotram"); // Shared with protection device
}

void pgm_028_025_state::igs025_to_igs028_callback()
{
//  printf("igs025_to_igs028_callback\n");
	m_igs028->handle_command();
}
...
void pgm_028_025_state::pgm_028_025_ol(machine_config &config)
{
	...
	m_igs025->set_source_cb(FUNC(pgm_028_025_state::source_data_r));

	IGS028(config, m_igs028);
}
