...
// ===============================> NEOGEO_DECRYPT_CART_DEVICE
	void cthd2k3a(machine_config &config);
	void jckeygpd(machine_config &config);
    void kf10thu(machine_config &config);
	void kf2k1pa(machine_config &config);
	void kf2k2plsd(machine_config &config);
	void kf2k2mpd(machine_config &config);
	void kf2k2mp2d(machine_config &config);
	void kof2k4pls(machine_config &config);
	void kof96ep(machine_config &config);
	void kof97pla(machine_config &config);
	void kof2002d(machine_config &config);
	void kogd(machine_config &config);
	void matrimd(machine_config &config);
	void samsho5d(machine_config &config);
    void samsh5spd(machine_config &config);

// ===============================> NEOGEO_DECRYPT_PVC_CART_DEVICE
	void mslug5d(machine_config &config);
    void mslug5e(machine_config &config);
	void kof2003d(machine_config &config);
	void kof2003hd(machine_config &config);
	void svcd(machine_config &config);

// ===============================> NEOGEO_SMA_DECRYPT_CART_DEVICE
	void garoud(machine_config &config);
	void garouhd(machine_config &config);
	void kof99d(machine_config &config);
	void kof2000d(machine_config &config);
	void kof2000nd(machine_config &config);
	void mslug3d(machine_config &config);
...
/******************************************************************************************************************************************************/
        ...
        case NEOGEO_KOGD:
			...
			break;
		case NEOGEO_KOF2K3D:
		case NEOGEO_KOF2K3ND:
		case NEOGEO_KOF2K3HD:
		case NEOGEO_MSLUG5D:
		case NEOGEO_MSLUG5E:
		case NEOGEO_SVCD:
			space.install_read_handler(0x2fe000, 0x2fffff, read16m_delegate(*m_slots[m_curr_slot], FUNC(neogeo_cart_slot_device::protection_r)));
...
void mvs_led_state::cthd2k3a(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_cthd2k3a");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::jckeygpd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "cmc50_jckeygpd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kf10thu(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kf10thu");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kf2k1pa(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kf2k1pa");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kf2k2plsd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kf2k2pd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kf2k2mpd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kf2k2mpd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kf2k2mp2d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kf2k2mp2d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2k4pls(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kof2k4pls");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof96ep(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kof96ep");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof97pla(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kof97pla");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2002d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "k2k2_kof2k2d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kogd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "boot_kogd");
}

void mvs_led_state::matrimd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "k2k2_matrimd");
}

void mvs_led_state::samsho5d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "k2k2_samsh5d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::samsh5spd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "k2k2_sams5sd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

// =======================================================================> NEOGEO_DECRYPT_PVC_CART_DEVICE

void mvs_led_state::mslug5d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "pvcd_mslug5d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::mslug5e(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "pvcd_mslug5e");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2003d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "pvcd_kf2k3d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2003hd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "pvcd_kf2k3hd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::svcd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "pvcd_svcd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

// =======================================================================> NEOGEO_SMA_DECRYPT_CART_DEVICE
void mvs_led_state::garoud(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_garoud");
}

void mvs_led_state::garouhd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_garouhd");
}

void mvs_led_state::kof99d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_kof99d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2000d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_kof2kd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::kof2000nd(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_kof2knd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}

void mvs_led_state::mslug3d(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "sma_mslug3d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
GAME( 2004, kf2k5uni,   kof2002,  kf2k5uni,  neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (bootleg of The King of Fighters 2002, set 2)", MACHINE_SUPPORTS_SAVE ) // fake SNK copyright
GAME( 2004, kof2k4se,   neogeo,   kof2k4se,  neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 (bootleg of The King of Fighters 2002)", MACHINE_SUPPORTS_SAVE ) /* Hack / Bootleg of kof2002 */
...
ROM_START( bangbedd )
	...
	NEO_SFIX_128K( "259-s1d.s1", CRC(bb50fb2d) SHA1(7372939f328fb5e7d09c16985e09ae8c34702b0c) )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "259-c1d.c1", 0x0000000, 0x800000, CRC(c50a91c3) SHA1(47ef41369b057b07bf143196e929ac5ab3679d33) )
	ROM_LOAD16_BYTE( "259-c2d.c2", 0x0000001, 0x800000, CRC(820ab36e) SHA1(acad44f815989d5908585cfeff5658fe85a50ad8) )
ROM_END
...
ROM_START( cthd2k3d )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "5003-c1d.bin", 0x0000000, 0x800000, CRC(29fd9108) SHA1(97e0c01692bffddf5c157c6a9e56573861029335) )
	ROM_LOAD16_BYTE( "5003-c2d.bin", 0x0000001, 0x800000, CRC(f58d4d3e) SHA1(d4276d4c9424fad2966cb3d49ac8f330b12ef7b6) )
	ROM_LOAD16_BYTE( "5003-c3d.bin", 0x1000000, 0x800000, CRC(71b3172d) SHA1(1b742b63e726f537df437df36b1bce35568c092a) )
	ROM_LOAD16_BYTE( "5003-c4d.bin", 0x1000001, 0x800000, CRC(564c70c1) SHA1(c67977f5be5a1cc9fbce4450a844967c019142c0) )
	ROM_LOAD16_BYTE( "5003-c5d.bin", 0x2000000, 0x800000, CRC(8ef8aef9) SHA1(ef464293c4fd720d6f59d243af9b064bc680c9f9) )
	ROM_LOAD16_BYTE( "5003-c6d.bin", 0x2000001, 0x800000, CRC(8a0fd440) SHA1(74428817d08d331a0bdd4a749ea578dff982f028) )
	ROM_LOAD16_BYTE( "5003-c7d.bin", 0x3000000, 0x800000, CRC(6f1effab) SHA1(a131bece8510f403ff1af4a52a03258a9714de4a) )
	ROM_LOAD16_BYTE( "5003-c8d.bin", 0x3000001, 0x800000, CRC(39550d3a) SHA1(8dbf219da2b39642c316164b8c28bcb350346250) )
ROM_END

ROM_START( cthd2k3da )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "5003-p1da.bin", 0x000000, 0x100000, CRC(83783954) SHA1(963a352bdc755b7c9cdf6b5f1c6b4f790061d6c3) )
	ROM_LOAD16_WORD_SWAP( "5003-p2da.bin", 0x100000, 0x400000, CRC(84b0b164) SHA1(1d7de20d8fc71c2e74a4fda17a2f41e2a6f027ba) )

	NEO_SFIX_128K( "5003-s1da.bin", CRC(956d8273) SHA1(15a0b51a194d6bddfa87d772837a4569fad59760) )

	NEO_BIOS_AUDIO_128K( "5003-m1da.bin", CRC(3ee21b7e) SHA1(6d74b2154f2b955c0f355306427b5b308acf6bff) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "262-v1-08-e0.v1", 0x000000, 0x400000, CRC(83d49ecf) SHA1(2f2c116e45397652e77fcf5d951fa5f71b639572) )
	ROM_LOAD( "5003-v2a.v2",0x400000, 0x400000, CRC(2b498449) SHA1(8e2b01dd17dbf4498a197bda8ce3e08cdf785f12) )
	ROM_LOAD( "262-v3-08-e0.v3", 0x800000, 0x400000, CRC(2ae38dbe) SHA1(4e82b7dd3b899d61907620517a5a27bdaba0725d) )
	ROM_LOAD( "262-v4-08-e0.v4", 0xc00000, 0x400000, CRC(26ec4dd9) SHA1(8bd68d95a2d913be41a51f51e48dbe3bff5924fb) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "5003-c1da.bin", 0x0000000, 0x800000, CRC(eddd5e2f) SHA1(2af647a57ec12ed60c37a3469adf3e58cb6728c6) )
	ROM_LOAD16_BYTE( "5003-c2da.bin", 0x0000001, 0x800000, CRC(23d8d1d6) SHA1(b831e2d506bf8c1436b48d34fc6e2d321602434d) )
	ROM_LOAD16_BYTE( "5003-c3d.bin", 0x1000000, 0x800000, CRC(71b3172d) SHA1(1b742b63e726f537df437df36b1bce35568c092a) )
	ROM_LOAD16_BYTE( "5003-c4d.bin", 0x1000001, 0x800000, CRC(564c70c1) SHA1(c67977f5be5a1cc9fbce4450a844967c019142c0) )
	ROM_LOAD16_BYTE( "5003-c5d.bin", 0x2000000, 0x800000, CRC(8ef8aef9) SHA1(ef464293c4fd720d6f59d243af9b064bc680c9f9) )
	ROM_LOAD16_BYTE( "5003-c6d.bin", 0x2000001, 0x800000, CRC(8a0fd440) SHA1(74428817d08d331a0bdd4a749ea578dff982f028) )
	ROM_LOAD16_BYTE( "5003-c7da.bin", 0x3000000, 0x800000, CRC(4f50e1ae) SHA1(676ecba2b3c5f1def2822559c1c1299d4eae503f) )
	ROM_LOAD16_BYTE( "5003-c8da.bin", 0x3000001, 0x800000, CRC(4f5f09bf) SHA1(1c2d66e793f7943c2c3bbc8390d455001f07baa4) )
ROM_END
...
ROM_START( cthd2k3a )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "5003-c1a.bin", 0x0000000, 0x800000, CRC(dc90c563) SHA1(a79f54f754a1bd0d603f70af6b335e839b5e20d1) )
	ROM_LOAD16_BYTE( "5003-c2a.bin", 0x0000001, 0x800000, CRC(7b08d331) SHA1(40e259cbc888184aa0f8102d00098f37f3005ce3) )
	...
	ROM_LOAD16_BYTE( "5003-c7a.bin", 0x3000000, 0x800000, CRC(ad2d72b3) SHA1(6396ba51f863019059ce3e37dab20a60d3a8c549) )
	ROM_LOAD16_BYTE( "5003-c8a.bin", 0x3000001, 0x800000, CRC(8c3fc1b5) SHA1(81b6df7c937915c5b971bde20786aece02404a05) )
ROM_END
...
ROM_START( ganryud )
	...
	NEO_SFIX_128K( "252-m1d.s1", CRC(a8dadec9) SHA1(e909764d0377705cde0cc0accfdaf9b520c1df02) )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "252-c1d.c1", 0x0000000, 0x800000, CRC(6bf7605b) SHA1(6710cbc27d6ec35648f98f0ca541aaaeeffd0980) )
	ROM_LOAD16_BYTE( "252-c2d.c2", 0x0000001, 0x800000, CRC(596792ce) SHA1(ad9c8f8b0e95396fade2b485d11a1b3d4cb65f37) )
ROM_END
...
ROM_START( garoud )
	...
	NEO_SFIX_512K( "253-m1d.s1", CRC(be2ba1a5) SHA1(e10dd25ba52ebe5caffc66135ba29f6624216b3d) )
...
ROM_START( jockygpd )
	...
	NEO_SFIX_128K( "008-s1d.s1", CRC(bb0efa71) SHA1(203a572acdb48dc7b904a8f1e0766a13bfcaa3d3) )

	NEO_BIOS_AUDIO_512K( "008-m1d.m1", CRC(1cab4de2) SHA1(112ff90806d8757db0685b88b762c45ed02548de) )

	ROM_REGION( 0x0200000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "008-v1.v1", 0x000000, 0x200000, CRC(443eadba) SHA1(3def3c22f0e276bc4c2fc7ff70ce473c08b0d2df) ) /* mask rom TC5316200 */

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "008-c1d.c1", 0x0000000, 0x800000, CRC(ea259019) SHA1(c14dc59a43e255ef12d8d832b2860f1a84c48170) )
	ROM_LOAD16_BYTE( "008-c2d.c2", 0x0000001, 0x800000, CRC(97f270be) SHA1(06e03b26bacb8568c69ccf22e58175426a69e01b) )
ROM_END
...
ROM_START( kof97pla )
	...
	ROM_FILL(0x1394A,1,0xD1)
	ROM_FILL(0x1394B,1,0x6C)
	ROM_FILL(0x1394C,1,0x01)
	ROM_FILL(0x1394D,1,0x3A)
	ROM_FILL(0x1394E,1,0x91)
	ROM_FILL(0x1394F,1,0x6C)

	NEO_SFIX_128K( "orochi-s1.bin", CRC(4ee2149a) SHA1(180a1a90021031eac1a643b769d9cdeda56518f5) ) // scrambled
...
ROM_START( kof97orod )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "232-p1o.p1", 0x000000, 0x100000, CRC(035911c5) SHA1(3321862384ec91174f1822cfdbc2bf1d1407e775) )
	ROM_LOAD16_WORD_SWAP( "232-p2.sp2", 0x100000, 0x400000, CRC(158b23f6) SHA1(9744620a70513490aaf9c5eda33e5ec31222be19) )

	NEO_SFIX_128K( "232-s1o.s1", CRC(cf6afb00) SHA1(aca3d9f571af3195a96bf044f353b3f0bc4cfc3a) )
...
ROM_START( kof99d )
	...
	NEO_SFIX_128K( "251-s1d.s1", CRC(1b0133fe) SHA1(7f8e743bc0c8384dec12ca7007d32b23fef8875d) )
...
ROM_START( kof2kd )
	...
	NEO_SFIX_512K( "257-s1d.s1", CRC(38901d4d) SHA1(c7684f66ab4ed577094da6ae143477c9df28d1fe) )

	NEO_BIOS_AUDIO_256K( "257-m1d.m1", CRC(d404db70) SHA1(8cd1f3e140a9a367de23544e76371b0491287909) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "257-c1d.c1", 0x0000000, 0x800000, CRC(abcdd424) SHA1(1d52aae8a7806d48c098c2a7a77dff6e02ac4870) )
	ROM_LOAD16_BYTE( "257-c2d.c2", 0x0000001, 0x800000, CRC(cda33778) SHA1(a619740364c952c443f27ed9b7c395610f2673c7) )
	ROM_LOAD16_BYTE( "257-c3d.c3", 0x1000000, 0x800000, CRC(087fb15b) SHA1(f77cb6e670cdf7709d84d770ecf28533cbfbe6de) )
	ROM_LOAD16_BYTE( "257-c4d.c4", 0x1000001, 0x800000, CRC(fe9dfde4) SHA1(23750ff0c4bc084d55eea66a5cdd0ef2d6c32cdc) )
	ROM_LOAD16_BYTE( "257-c5d.c5", 0x2000000, 0x800000, CRC(03ee4bf4) SHA1(8f26c5bc525a5786de8e25797e2875a1dfe527be) )
	ROM_LOAD16_BYTE( "257-c6d.c6", 0x2000001, 0x800000, CRC(8599cc5b) SHA1(9a05fc12273aebfbc4ac22e88b32ae9ecd269462) )
	ROM_LOAD16_BYTE( "257-c7d.c7", 0x3000000, 0x800000, CRC(71dfc3e2) SHA1(1889a8dc88993e35f9fd93ce2bee1de52995932d) )
	ROM_LOAD16_BYTE( "257-c8d.c8", 0x3000001, 0x800000, CRC(0fa30e5f) SHA1(0cb7fa6b0219e1af2df9b97786c677651a78f37a) )
ROM_END
...
ROM_START( kof2k1d )
	...
	NEO_SFIX_128K( "262-s1d.s1", CRC(6d209796) SHA1(95fdb865e47d37916573ba12e8ba4a4aaece1cba) )

	NEO_BIOS_AUDIO_128K( "262-m1d.m1",  CRC(2fb0a8a5) SHA1(9878370ff8cef3e9c9f307ad64c29522dd625c8f) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "262-c1d.c1", 0x0000000, 0x800000, CRC(103225b1) SHA1(41486c7bb421b6b54f3ca07621aabd907bf10e15) )
	ROM_LOAD16_BYTE( "262-c2d.c2", 0x0000001, 0x800000, CRC(f9d05d99) SHA1(c135dd3d5584dc58a46315d64f663e34bb64bebf) )
	ROM_LOAD16_BYTE( "262-c3d.c3", 0x1000000, 0x800000, CRC(4c7ec427) SHA1(0156e2f79e7a62b15acc2314ac6563a67af0f256) )
	ROM_LOAD16_BYTE( "262-c4d.c4", 0x1000001, 0x800000, CRC(1d237aa6) SHA1(b007fe9f1f32f0ff947c6575741b47fb70976728) )
	ROM_LOAD16_BYTE( "262-c5d.c5", 0x2000000, 0x800000, CRC(c2256db5) SHA1(dae6b7b0673b431f223d82f7c3a685de70a1c035) )
	ROM_LOAD16_BYTE( "262-c6d.c6", 0x2000001, 0x800000, CRC(8d6565a9) SHA1(137C950D588D40C812C36967EC17D04D4FC56362) )
	ROM_LOAD16_BYTE( "262-c7d.c7", 0x3000000, 0x800000, CRC(d1408776) SHA1(e77c786070b2b851a8a36250722b4c902e7213ed) )
	ROM_LOAD16_BYTE( "262-c8d.c8", 0x3000001, 0x800000, CRC(954d0e16) SHA1(975803c130df3a6e835b9bf0f8532d6586058c54) )
ROM_END
...
ROM_START( kf2k1plap )
	...
	NEO_SFIX_128K( "2k1-s1pad.bin", CRC(a4da10fd) SHA1(3b5f73d284f0f912d96e07d7b30122eaa43a04a8) )
...
ROM_START( kof2k2d )
	...
	NEO_SFIX_128K( "265-s1d.s1", CRC(e0eaaba3) SHA1(831b642da9fe7617498cdb1c86475b3b3d3043bc) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "265-c1d.c1", 0x0000000, 0x800000, CRC(7efa6ef7) SHA1(71345a4202e7cc9239538fb978638141416c8893) )
	ROM_LOAD16_BYTE( "265-c2d.c2", 0x0000001, 0x800000, CRC(aa82948b) SHA1(b2a40797f68bdeb80bc54dccc5495be68934bf0e) )
	ROM_LOAD16_BYTE( "265-c3d.c3", 0x1000000, 0x800000, CRC(959fad0b) SHA1(63ab83ddc5f688dc8165a7ff8d262df3fcd942a2) )
	ROM_LOAD16_BYTE( "265-c4d.c4", 0x1000001, 0x800000, CRC(efe6a468) SHA1(2a414285e48aa948b5b0d4a9333bab083b5fb853) )
	ROM_LOAD16_BYTE( "265-c5d.c5", 0x2000000, 0x800000, CRC(74bba7c6) SHA1(e01adc7a4633bc0951b9b4f09abc07d728e9a2d9) )
	ROM_LOAD16_BYTE( "265-c6d.c6", 0x2000001, 0x800000, CRC(e20d2216) SHA1(5d28eea7b581e780b78f391a8179f1678ee0d9a5) )
	ROM_LOAD16_BYTE( "265-c7d.c7", 0x3000000, 0x800000, CRC(8a5b561c) SHA1(A19697D4C2CC8EDEBC669C95AE1DB4C8C2A70B2C) )
	ROM_LOAD16_BYTE( "265-c8d.c8", 0x3000001, 0x800000, CRC(bef667a3) SHA1(D5E8BC185DCF63343D129C31D2DDAB9F723F1A12) )
ROM_END
...
ROM_START( kf2k2plbd )
	...
	NEO_SFIX_128K( "2k2-s1pa.bin", CRC(2072d5e9) SHA1(45f9eb101f4b58ce40c307fd9fa8b1e95215a81b) )
...
ROM_START( kf2k2pldd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "2k2-p1pl.bin", 0x000000, 0x100000, CRC(ea1b6e9c) SHA1(cd03c205eb775f133d1f13b1524aac17ec1a6ce3) )
	ROM_LOAD16_WORD_SWAP( "265-p2.sp2",  0x100000, 0x400000, CRC(327266b8) SHA1(98f445cc0a94f8744d74bca71cb420277622b034) )

	NEO_SFIX_128K( "2k2-s1pl.bin", CRC(7df52924) SHA1(4b89eb6a2eeeccf5aef40b0775d61970ea9de60c) )
...
ROM_START( kf2k2mpp )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k2mpp.bin", 0x000000, 0x100000, CRC(4da7a8f6) SHA1(5efe22dfc2a1cbaaa479d06199d818e3af81fc67) )
	ROM_LOAD16_WORD_SWAP( "k2k2m2p2.bin", 0x100000, 0x400000, CRC(432fdf53) SHA1(d7e542cd84d948162c60768e40ee4ed33d8e7913) )

	NEO_SFIX_128K( "kf02m-s1p.bin", CRC(29c0693e) SHA1(a852d15a8558b4a1cadf1ed9ef357d765ff88d35) )
...
ROM_START( kf2k2mp2p )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k2m2p2p.bin", 0x000000, 0x100000, CRC(f8c7efd7) SHA1(39f249405d3b0993748773ca54cbe50d1a191c79) )
	ROM_LOAD16_WORD_SWAP( "k2k2m2p2.bin", 0x100000, 0x400000, CRC(432fdf53) SHA1(d7e542cd84d948162c60768e40ee4ed33d8e7913) )

	NEO_SFIX_128K( "k2k2m2s1p.bin", CRC(df4ce33b) SHA1(1287c84c16e17df7d5887af57fc6657da452d0ae) )
...
ROM_START( kof2k3d )
	...
	NEO_SFIX_512K( "271-s1d.s1", CRC(3230e10f) SHA1(a7aa4c11be7de5969e00338c7f424811174a8ad6) )
...
ROM_START( kf2k3bd )
	...
	NEO_SFIX_128K( "2k3-s1bd.bin", CRC(c47f8ac3) SHA1(502070fa57e59d36e5e544e1e2836fefa18a5743) )

	NEO_BIOS_AUDIO_128K( "2k3-m1.bin", CRC(3a4969ff) SHA1(2fc107a023a82053a8df63025829bcf12cee9610) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "271-v1bd.v1", 0x000000, 0x400000, CRC(d2b8aa5e) SHA1(498f0556c1de56822141f8043f1ce20444f4ed0a) )
	ROM_LOAD( "271-v2bd.v2", 0x400000, 0x400000, CRC(71956ee2) SHA1(a890941e60db358cf45b58909f4719f4826f3bb1) )
	ROM_LOAD( "271-v3bd.v3", 0x800000, 0x400000, CRC(ddbbb199) SHA1(0eea4b064bdb8daa03c354fe0a0aa27c4c665bda) )
	ROM_LOAD( "271-v4bd.v4", 0xc00000, 0x400000, CRC(01b90c4f) SHA1(387164aa1995d8c11ed939b3afbc294d86d2e27f) )
...
ROM_START( kof2k3hd )
	...
	NEO_SFIX_512K( "271-s1kd.s1", CRC(1d4ecb1e) SHA1(115101010fe739e6a684498ba5e6e468b62181b9) )
	...
	ROM_LOAD16_BYTE( "271-c5d.c5", 0x2000000, 0x800000, CRC(8a91aae4) SHA1(802f4baacf801646be1ef686e105b2e867a6a5df) )
	ROM_LOAD16_BYTE( "271-c6d.c6", 0x2000001, 0x800000, CRC(9f8674b8) SHA1(65964f40b2227d020023fb436579927e65807dcd) )
	ROM_LOAD16_BYTE( "271-c7kd.c7", 0x3000000, 0x800000, CRC(efe714f8) SHA1(c239744cf372f6f7b2cd1b539a59f792038fe179) )
	ROM_LOAD16_BYTE( "271-c8kd.c8", 0x3000001, 0x800000, CRC(c015cdb7) SHA1(baa1bf179f13e07bd93d33bf40b37deaf65d0b0c) )
ROM_END

ROM_START( kof2k3nd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "271-p1nd.p1", 0x000000, 0x800000, CRC(11624854) SHA1(a7488a0f5d731656aa82cc51282adcfe6ad9f658) )

	NEO_SFIX_128K( "271-s1nd.s1", CRC(df422440) SHA1(ed84dfd6cc5a73f3ef35db6616bcc3b45754aa4d) )

	NEO_BIOS_AUDIO_512K( "271-m1nd.m1", CRC(0e86af8f) SHA1(769102b67bb1a699cfa5674d66cdb46ae633cb65) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "271-v1nd.v1", 0x000000, 0x1000000, CRC(2964f36e) SHA1(bfc52f81354eb57e27acb3b80fe1547b9e070293) )
...
ROM_START( kf2k3pd )
    ...
    NEO_SFIX_512K( "2k3-s1pd.bin", CRC(71b538cf) SHA1(d230aa4bd6eb24a08faebfc948a62c4b31d84b41) )
...
ROM_START( kf2k3upd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "2k3-p1ud.bin", 0x000000, 0x800000, CRC(4793b724) SHA1(e49b8496c55bdcf12a8bf0e65f249c68339cc568) )

	NEO_SFIX_512K( "2k3-s1ud.bin", CRC(3df88da7) SHA1(50ad48ef1e57bbf522d9e6c0c9e7f88c4a96d1f9) )
...
ROM_START( kf2k4plsp )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k4s-p1pp.bin", 0x000000, 0x100000, CRC(388c5cba) SHA1(a9dbb3cbe622f8d7c28079883d54665da522dea9))
	ROM_LOAD16_WORD_SWAP( "k2k4s-p2pp.bin", 0x100000, 0x400000, CRC(698679a7) SHA1(2bf3a7a7423141685ecd36c266139a97bac0a69c))

	NEO_SFIX_128K( "k2k4s-s1pp.bin", CRC(348686dd) SHA1(676d83b98cc0b923ef4997c04cecaf74b4ef1687))

	NEO_BIOS_AUDIO_128K( "k2k4s-m1.bin", CRC(5a47d9ad) SHA1(0197737934653acc6c97221660d789e9914f3578) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "k2k4se-v1.bin", 0x000000, 0x400000, CRC(8991f6e9) SHA1(ce5afc0169c142d7f98111afbc60b3a9a2e17256) )
	ROM_LOAD( "k2k4se-v2.bin", 0x400000, 0x400000, CRC(511e4d2f) SHA1(28190ec86ac2169ab6fad80635ed13cfcf430c65) )
	ROM_LOAD( "k2k4se-v3.bin", 0x800000, 0x400000, CRC(1dd8b53a) SHA1(9aa84f145ba07f5f3c3b3fb682eb8a8ab1500b4c) )
	ROM_LOAD( "k2k4se-v4.bin", 0xc00000, 0x400000, CRC(63bb5462) SHA1(afc6a085e25bd006f26e16beda4244bc8bc19bb8) )
...
ROM_START( kogd )
	...
	ROM_REGION( 0x2800000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "5232-c1d.bin", 0x0000000, 0x800000, CRC(8e964a75) SHA1(e7611d7908ca056f4b3c0ae2c4da8f6809db4556) )
	ROM_LOAD16_BYTE( "5232-c2d.bin", 0x0000001, 0x800000, CRC(d102de17) SHA1(e98f33a4d16ebda6cf369b92480d4306c780cf8b) )
	ROM_LOAD16_BYTE( "232-c3.c3", 0x1000000, 0x800000, CRC(581d6618) SHA1(14d3124a08ded59f86932c6b28e1a4e48c564ccd) )
	ROM_LOAD16_BYTE( "232-c4.c4", 0x1000001, 0x800000, CRC(49bb1e68) SHA1(f769c1bd1b019521111ff3f0d22c63cb1f2640ef) )
	ROM_LOAD16_BYTE( "5232-c5d.bin", 0x2000000, 0x400000, CRC(c2698be3) SHA1(0b1d414549947f6c29ebc71057aef96634656f32) )
	ROM_LOAD16_BYTE( "5232-c6d.bin", 0x2000001, 0x400000, CRC(b057db30) SHA1(2f342f03848f3f553bc70b2dbee2cc388a344a06) )
ROM_END

ROM_START( kogplusd ) 
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "5232-p1pd.bin", 0x000000, 0x100000, CRC(98241142) SHA1(9bb2c382063f84920841463f9b4ca87862e336de) )
	ROM_LOAD16_WORD_SWAP( "kf97-p2p.bin", 0x100000, 0x400000, CRC(5502b020) SHA1(37c48198d8b3798910a44075782cd1a20b687b4a) )

	NEO_SFIX_128K( "5232-s1pd.bin", CRC(1a58ab17) SHA1(964ef974570923743124f4879baa8582ed4fc9f9) )
...
ROM_START( kof10thu )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "kf10-p1u.bin", 0x600000, 0x100000, CRC(dd135fb6) SHA1(4e85814a44ee9fee9760048dd6d6fd2b66521bb1) )
	ROM_CONTINUE( 0x100000, 0x500000 )
	ROM_CONTINUE( 0x000000, 0x100000 )
	ROM_CONTINUE( 0x700000, 0x100000 )

    NEO_SFIX_128K( "kf10-s1u.bin", CRC(b22ba74f) SHA1(3ba9e9d4b95fef9bf35f76e9d4fb6e1a36aeee5a) )
...
ROM_START( kf10thepp )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "kf10-p1tp.bin", 0x000000, 0x800000, CRC(c32c1e5c) SHA1(ab5b37b7ca1ee7c3a3d2cb2b6d8b514961af86fe) )

	NEO_SFIX_128K( "kf10-s1tp.bin", CRC(7f930e3c) SHA1(5832e5d6a3c7c6956a0fbc37881cd3c209e6d68f) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "k2k4u-c4.bin", 0x0000000, 0x800000, CRC(2491af91) SHA1(e3e237e50395dc985c564867046ad202bc744d37) )
	ROM_LOAD16_BYTE( "kf10-c8tp.bin", 0x0000001, 0x800000, CRC(9acebe91) SHA1(24af9f4f9026bfa93f64f7c497e26f48b5cae9a8) )
	...
	ROM_LOAD16_BYTE( "kf10-c1tp.bin", 0x3000000, 0x800000, CRC(86e02dae) SHA1(18499d139c696dbd37a05d537dbcc9ef521a2c9b) )
	ROM_LOAD16_BYTE( "kf10-c5tp.bin", 0x3000001, 0x800000, CRC(891bb509) SHA1(aa438e460b6a5272fcd9400ae3502c0ee3a53190) )
ROM_END

ROM_START( kf2k5unid )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k4s-p1d.bin", 0x000000, 0x800000, CRC(acbe077a) SHA1(7d3b1ce4e06021f26dd1a7d97b03975f4ed17c24) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "k2k4u-c4.bin", 0x0000000, 0x800000, CRC(2491af91) SHA1(e3e237e50395dc985c564867046ad202bc744d37) )
	ROM_LOAD16_BYTE( "k2k4u-c8.bin", 0x0000001, 0x800000, CRC(47ff1d91) SHA1(7d6ade9409af2c64114ed5836ccf9f50c7ebac69) )
	ROM_LOAD16_BYTE( "k2k4s-c3.bin", 0x1000000, 0x800000, CRC(959fad0b) SHA1(63ab83ddc5f688dc8165a7ff8d262df3fcd942a2) )
	ROM_LOAD16_BYTE( "k2k4s-c7.bin", 0x1000001, 0x800000, CRC(efe6a468) SHA1(2a414285e48aa948b5b0d4a9333bab083b5fb853) )
	ROM_LOAD16_BYTE( "k2k4s-c2.bin", 0x2000000, 0x800000, CRC(74bba7c6) SHA1(e01adc7a4633bc0951b9b4f09abc07d728e9a2d9) )
	ROM_LOAD16_BYTE( "k2k4s-c6.bin", 0x2000001, 0x800000, CRC(e20d2216) SHA1(5d28eea7b581e780b78f391a8179f1678ee0d9a5) )
...
ROM_START( kofse2k4 )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k4se-p2.bin", 0x000000, 0x100000, CRC(5f482757) SHA1(0c2cba7fc6256e62eb7464306036784703c35a70) )
	ROM_LOAD16_WORD_SWAP( "k2k4s-p1.bin", 0x100000, 0x400000, CRC(e6c50566) SHA1(cc6a3489a3bfeb4dcc65b6ddae0030f7e66fbabe) )
...
ROM_START( kofse2k4p )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "k2k4s-p1se.bin", 0x000000, 0x100000, CRC(78d58d52) SHA1(7475f74d7f95434e0cfd8d57f4469daf7792bad0))
	ROM_LOAD16_WORD_SWAP( "k2k4s-p2pp.bin", 0x100000, 0x400000, CRC(698679a7) SHA1(2bf3a7a7423141685ecd36c266139a97bac0a69c))
...
ROM_START( lans2k4d )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "lnsq-p1d.bin", 0x000000, 0x100000, CRC(724576EA) SHA1(075f5d8ccb7303c8b6bebf630c4fa9c204554044) )
	ROM_LOAD16_WORD_SWAP( "246-p2.sp2", 0x100000, 0x400000, CRC(72ea04c3) SHA1(4fb1d22c30f5f3db4637dd92a4d2705c88de399d) ) /* TC5332205 */
	...
	ROM_LOAD16_BYTE( "lnsq-c3d.bin", 0x1000000, 0x800000, CRC(b28d702a) SHA1(21d70c94ecf9ca519b4e50e2d31620f6dfab9ad0) )
	ROM_LOAD16_BYTE( "lnsq-c4d.bin", 0x1000001, 0x800000, CRC(da10dd64) SHA1(55bf0922a117325ef6479f654caf13b287a16f67) )
	ROM_LOAD16_BYTE( "lnsq-c5d.bin", 0x2000000, 0x800000, CRC(bab3b417) SHA1(232f718fecf597434b7a93602387fabab2bda9c0) )
	ROM_LOAD16_BYTE( "lnsq-c6d.bin", 0x2000001, 0x800000, CRC(4c089a28) SHA1(f854ce46b4723aa971de280007268d474d2a6361) )
ROM_END
...
ROM_START( matrimd )
	...
	NEO_SFIX_512K( "266-s1d.s1", CRC(10b1ce57) SHA1(de40a742508eb44995c1fb467aef5c3aed403497) )

	NEO_BIOS_AUDIO_128K( "266-m1d.m1", CRC(d2f3742d) SHA1(dd42f8a301f07e079fbc2bfd23e788baa03ca72d) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "266-v1d.v1", 0x000000, 0x800000, CRC(328b2194) SHA1(6734da4f1e882a8524c04ff375567ed96a2dae5e) )
	ROM_LOAD( "266-v2d.v2", 0x800000, 0x800000, CRC(2a13562d) SHA1(dc13f1af6afaf43f2ac20b7cf1c751a047450312) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "266-c1d.c1", 0x0000000, 0x800000, CRC(0ab54c54) SHA1(31bca460462b8545b3e5264804987ab951e9b202) )
	ROM_LOAD16_BYTE( "266-c2d.c2", 0x0000001, 0x800000, CRC(b834dd89) SHA1(579470839a8d23b2d22cf727d2b43c6c3c113e1f) )
	ROM_LOAD16_BYTE( "266-c3d.c3", 0x1000000, 0x800000, CRC(f31d68d4) SHA1(a6b8aaf11d25f871b52e9626fe0e4ae0683c3c52) )
	ROM_LOAD16_BYTE( "266-c4d.c4", 0x1000001, 0x800000, CRC(58cfb6e9) SHA1(106875db996ec29b0254b34f9d935c761cde20c4) )
	ROM_LOAD16_BYTE( "266-c5d.c5", 0x2000000, 0x800000, CRC(f3c0e3fd) SHA1(3a2f14517617fb98a202ceec88d52891e1438c8e) )
	ROM_LOAD16_BYTE( "266-c6d.c6", 0x2000001, 0x800000, CRC(b53c8dcf) SHA1(9f4b0bac92262e8c1c1055a70f13c7c326367f73) )
	ROM_LOAD16_BYTE( "266-c7d.c7", 0x3000000, 0x800000, CRC(3c1fb02a) SHA1(43e170e6d48c01d8c323f9309f97e6038bab20d7) )
	ROM_LOAD16_BYTE( "266-c8d.c8", 0x3000001, 0x800000, CRC(5ee31f80) SHA1(3cdd8037f5004df92f4c19ba0746c8bccb4e2473) )
ROM_END

ROM_START( matrimbd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "mart-p1a.bin", 0x000000, 0x100000, CRC(1e59c746) SHA1(9a6cdb6c56d5a80e373bb5ec476f1e7c3b3fbba9) )
	ROM_LOAD16_WORD_SWAP( "mart-p2a.bin", 0x100000, 0x400000, CRC(b0132cef) SHA1(3780db1b8947a8371a46b67ca1a14a12bf97986b) )

	NEO_SFIX_128K( "mart-s1a.bin", CRC(aff2a3be) SHA1(57aba048573eacf8fbdd228f04a7f30da64cebe5) )

	NEO_BIOS_AUDIO_128K( "266-m1d.m1", CRC(d2f3742d) SHA1(dd42f8a301f07e079fbc2bfd23e788baa03ca72d) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "mart-v1.bin", 0x000000, 0x400000, CRC(352b0a07) SHA1(19f7cc12f3f6d0fda9c7449816c4c32367447897) )
	ROM_LOAD( "mart-v2a.bin", 0x400000, 0x400000, CRC(945f8831) SHA1(6ac9bd41e0bb33601c82ebeb2aa5b1b8b91fada1) )
	ROM_LOAD( "mart-v3.bin", 0x800000, 0x400000, CRC(e8362fcc) SHA1(42d558fd80cabe22a1c09a1fa75741afbcf46b7c) )
	ROM_LOAD( "mart-v4a.bin", 0xc00000, 0x400000, CRC(393c9a62) SHA1(0eaee0007557e59e64edcdbca229e6f776de9aef) )
...
ROM_START( msboot )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "201-p1b.p1", 0x000000, 0x100000, CRC(556ae6a4) SHA1(23399566a452cb5d3a758c30d42b2011445a9952) )
    ROM_LOAD16_WORD_SWAP( "201-p2b.sp2", 0x100000, 0x100000, CRC(c4d10926) SHA1(af4fcc768756485f7979d60ff3fa3a7371865c19) )
	...
	ROM_REGION( 0x800000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "201-v1b.v1", 0x000000, 0x200000, CRC(2c05fd7c) SHA1(4f28bc799da0e27b2f3cde364d8c9822468abb8f) )
	ROM_LOAD( "201-v2b.v2", 0x200000, 0x200000, CRC(752de272) SHA1(1e9ffb296a1089e15b23455841ad91e8a565ba62) )
	ROM_LOAD( "201-v3b.v3", 0x400000, 0x200000, CRC(aa48faa6) SHA1(4695b9dafdc13997410cbd7954c2a7f1b5e4649d) )
	ROM_LOAD( "201-v4b.v4", 0x600000, 0x200000, CRC(4264444b) SHA1(7c248e8e559c67d6e8474ec6ce5cf2e3e41235e4) )
...
ROM_START( ms3b6boot )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "ms3-p1b.bin", 0x000000, 0x100000, CRC(1f1079a2) SHA1(5d99358f0e513e2087c7594bab09c8d33db40f1f) )
	ROM_LOAD16_WORD_SWAP( "299-p2.bin", 0x100000, 0x400000, CRC(193fa835) SHA1(fb1f26db7998b0bb6b1c8b92500c1596ec5dfc71) )
  
	NEO_SFIX_128K( "ms3-s1b.bin", CRC(39f1a271) SHA1(07835758801f31876274a25bc7796abe1b5f052b) )
	...
	ROM_LOAD16_BYTE( "256-c7d.c7", 0x3000000, 0x800000, CRC(9395b809) SHA1(ca9ac9832017094eee3623f0b6c4c4b7b4f1374d) )
	ROM_LOAD16_BYTE( "256-c8d.c8", 0x3000001, 0x800000, CRC(a369f9d4) SHA1(f8146ea80a1a23da7e7e04c88f778ee9abdfeb5c) )
ROM_END

ROM_START( ms4boot )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "263-p1nd.p1", 0x000000, 0x100000, CRC(4d7e6624) SHA1(125d5203e89cce23a851fa74cc8cbe003ef978f3) )
	ROM_LOAD16_WORD_SWAP( "263-p2.sp2",   0x100000, 0x400000, CRC(fdb7aed8) SHA1(dbeaec38f44e58ffedba99e70fa1439c2bf0dfa3) )
   
	NEO_SFIX_128K( "263-s1d.s1", CRC(a9446774) SHA1(c5a309fd8ee6d6750a15c82e710218a3755e38b2) )

	NEO_BIOS_AUDIO_128K( "263-m1d.m1", CRC(ef5db532) SHA1(4aeba9e206b8f309610eb7e1891644f39aa61830) )

    ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "ms4-v1b.bin", 0x000000, 0x800000, CRC(fd6b982e) SHA1(100313166c9ec57f1c540de05625c506b30ad13c) )
	ROM_LOAD( "ms4-v2b.bin", 0x800000, 0x800000, CRC(20125227) SHA1(2e350c0c580e87445bf103c01fc62b14f0c19216) )
	
	ROM_REGION( 0x2800000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "263-c1nd.c1", 0x0000000, 0x800000, CRC(361ddda6) SHA1(95f329019660f1ec7f15f6ea1e0c2bfc84b02ca8) )
	ROM_LOAD16_BYTE( "263-c2nd.c2", 0x0000001, 0x800000, CRC(15d192c4) SHA1(0b9afb62a1d4d764d616408b09e17a05fc4a87e7) )
	ROM_LOAD16_BYTE( "263-c3nd.c3", 0x1000000, 0x800000, CRC(63fb79ff) SHA1(a7da0a554034792721abda4369a71b0c8045f334) )
	ROM_LOAD16_BYTE( "263-c4nd.c4", 0x1000001, 0x800000, CRC(e8623126) SHA1(66c2b874cd55c628e7e6768d6f31180c29a734e7) )
	ROM_LOAD16_BYTE( "263-c5nd.c5", 0x2000000, 0x400000, CRC(3348dc5d) SHA1(a119e80aa2b36a7d8c7e8debd0eb13441a19adff) )
	ROM_LOAD16_BYTE( "263-c6nd.c6", 0x2000001, 0x400000, CRC(d90fc1a0) SHA1(0eaf5f658212c19a4cdbcdbff3b04389a2be76bb) )
ROM_END

ROM_START( ms5boot )
    ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
    ROM_LOAD16_WORD_SWAP( "ms5-p1bt.bin", 0x000000, 0x100000, CRC(e6d297af) SHA1(5bb3f72ce26e3f46c523b955f425056eb246e855) )
    ROM_LOAD16_WORD_SWAP( "ms5-p2bt.bin", 0x200000, 0x100000, CRC(3fc46cfa) SHA1(f20d3d359f6cdbf6aabb6920020621b02bafee91) )
    ROM_CONTINUE(0x400000, 0x100000 )
    ROM_LOAD16_WORD_SWAP( "ms5-p3bt.bin", 0x300000, 0x100000, CRC(742c955a) SHA1(96c0f08b1f2f6877f5169a96c13b67f3be6082c6) )
    ROM_CONTINUE(0x500000, 0x100000 )
...
//	ROM_CONTINUE(           0x00000, 0x10000 )
	...
	NEO_SFIX_128K( "268-s1d.s1", CRC(64952683) SHA1(88ec728c2fe18a11fdd218bed5d73bb3affe2ec1) )

	NEO_BIOS_AUDIO_256K( "ms5-m1bt.bin", CRC(792e07c1) SHA1(117516e8ec9026c7682ab27857aab6639bef5835) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "ms5-v1bt.bin", 0x000000, 0x400000, CRC(c3540e0d) SHA1(bf7ca3abe291b28a4cfaef791f0c556cc98ad8d8) )
	ROM_LOAD( "ms5-v2bt.bin", 0x400000, 0x400000, CRC(077bd2f4) SHA1(1699959d17f8c7113cebdb9da2e1cd18ce48486c) )
	ROM_LOAD( "ms5-v3bt.bin", 0x800000, 0x400000, CRC(39b14567) SHA1(1658612a93ba30130f9260bc41d3f18f6b90c1e7) )
	ROM_LOAD( "ms5-v4bt.bin", 0xc00000, 0x400000, CRC(969ff3b2) SHA1(50feceb741a1c08b000b077a33151ab1352eb798) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "ms5-c1bt.bin", 0x0000000, 0x800000, CRC(969c0d62) SHA1(DE3C5CFA980CCA2FAB0416AC0D292948B5D4C9C3) )
	ROM_LOAD16_BYTE( "ms5-c2bt.bin", 0x0000001, 0x800000, CRC(c69ae867) SHA1(3198EE5C7C2C7563B49EBD9F7BA95D9B0B303F6C) )
	ROM_LOAD16_BYTE( "ms5-c3bt.bin", 0x1000000, 0x800000, CRC(d7beaeaf) SHA1(99443EA4C1BAB45F1977A390EB7E1A0163915110) )
	ROM_LOAD16_BYTE( "ms5-c4bt.bin", 0x1000001, 0x800000, CRC(e1b1131b) SHA1(68a36d336582069e79ad481638d92f57c4cd6523) )
	ROM_LOAD16_BYTE( "ms5-c5bt.bin", 0x2000000, 0x800000, CRC(2fa1a5ad) SHA1(4AE15D29BA979601598EDDF8905072FE1D9E0A98) )
	ROM_LOAD16_BYTE( "ms5-c6bt.bin", 0x2000001, 0x800000, CRC(6de89589) SHA1(86A6C036BF51AF516FEA83A30874026EC1586A83) )
	ROM_LOAD16_BYTE( "ms5-c7bt.bin", 0x3000000, 0x800000, CRC(97bd0c0a) SHA1(30F3280FE527098ECF46541CC645A59B366105EA) )
	ROM_LOAD16_BYTE( "ms5-c8bt.bin", 0x3000001, 0x800000, CRC(c0d5bc20) SHA1(b5d0d81d5cc624538b0651c568295e578a1330d1) )
ROM_END
...
ROM_START( ms4plusd )
	...
	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "263-v1d.v1", 0x000000, 0x400000, CRC(8cb5a9ef) SHA1(272ad312f8694acf9190ebf48d1c8a5fec73c130) )
	ROM_LOAD( "263-v2d.v2", 0x400000, 0x400000, CRC(94217b1e) SHA1(c468a192e2ec0952a20cfd9e391cf6c12346efb3) )
	ROM_LOAD( "263-v3d.v3", 0x800000, 0x400000, CRC(7616fcec) SHA1(83006094379d0373b967603dcaa1cec69c2f746f) )
	ROM_LOAD( "263-v4d.v4", 0xC00000, 0x400000, CRC(7b0b92a1) SHA1(c14320c4652de16ff2535f8743ce0e71ba135e75) )

	ROM_REGION( 0x3000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "263-c1d.c1", 0x0000000, 0x800000, CRC(a75ffcde) SHA1(97f405a95a56615ae49f79e1a69f98cc2f2434ef) )
	ROM_LOAD16_BYTE( "263-c2d.c2", 0x0000001, 0x800000, CRC(5ab0d12b) SHA1(8a3d95dd2e9cc1b6dcf6a957fed43ee390248307) )
	ROM_LOAD16_BYTE( "263-c3d.c3", 0x1000000, 0x800000, CRC(61af560c) SHA1(aa7bc45e03a6bbd18eb56d118d4932102ccb196a) )
	ROM_LOAD16_BYTE( "263-c4d.c4", 0x1000001, 0x800000, CRC(f2c544fd) SHA1(179b064f81b49f5808d7a7a5bce28e95b09e5abe) )
	ROM_LOAD16_BYTE( "263-c5d.c5", 0x2000000, 0x800000, CRC(84c66c44) SHA1(9273f44bf11891aa04ddd2cbb6442d084c2a2e04) )
	ROM_LOAD16_BYTE( "263-c6d.c6", 0x2000001, 0x800000, CRC(5ed018ab) SHA1(e78501fa8a80960093a4d54ce952681a98300148) )
ROM_END
...
ROM_START( ms5plusd )
	...
	NEO_BIOS_AUDIO_512K( "268-m1d.m1", CRC(39f3cbba) SHA1(56f9ba6a1ecfc28733b7b88c9796415cba0461f2) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "268-v1d.v1", 0x000000, 0x800000, CRC(7ff6ca47) SHA1(e36c4e6a349dd9fd38d1a36b6760bbd943c2a42f) )
	ROM_LOAD( "268-v2d.v2", 0x800000, 0x800000, CRC(696cce3b) SHA1(538d4a25befa4ffd25a48df97380469c13980f7a) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
    ROM_LOAD16_BYTE( "268-c1d.c1", 0x0000000, 0x800000, CRC(e8239365) SHA1(E0A75902A783110049730B66AD3CBCCDD804BF62) )
	ROM_LOAD16_BYTE( "268-c2d.c2", 0x0000001, 0x800000, CRC(89b21d4c) SHA1(862AC31CE9570529B33E6F58ADA0AC867A442679) )
	ROM_LOAD16_BYTE( "268-c3d.c3", 0x1000000, 0x800000, CRC(3cda13a0) SHA1(5D029C92688384EAFD65AD711A2954D0B86A3163) )
	ROM_LOAD16_BYTE( "268-c4d.c4", 0x1000001, 0x800000, CRC(9c00160d) SHA1(C612102F9CD288BBA4C245B5855D795E4362B217) )
	ROM_LOAD16_BYTE( "268-c5d.c5", 0x2000000, 0x800000, CRC(38754256) SHA1(744d91d041998ca27ee2781188746797c65377bd) )
	ROM_LOAD16_BYTE( "268-c6d.c6", 0x2000001, 0x800000, CRC(59d33e9c) SHA1(ed7f5c7db4c35ec5a7db0ad5436110b3fe80b89a) )
	ROM_LOAD16_BYTE( "268-c7d.c7", 0x3000000, 0x800000, CRC(c9f8c357) SHA1(7064224AFA887F57245F5479B0B46228539A131B) )
	ROM_LOAD16_BYTE( "268-c8d.c8", 0x3000001, 0x800000, CRC(fafc3eb9) SHA1(F4F73194CC7FD151BE3CA2561F993B5BE7628369) )
ROM_END
...
ROM_START( mslug3d )
	...
	NEO_SFIX_128K( "256-s1d.s1", CRC(8458fff9) SHA1(b120d096deae8abf0ad98362ce230b66e7315a14) )
...
ROM_START( mslug4nd )
	...
	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "263-v1nd.v1", 0x000000, 0x400000, CRC(c1b2af81) SHA1(532dca0a2b2e03d50c6ac3adc9ebceb413f61690) )
	ROM_LOAD( "263-v2nd.v2", 0x400000, 0x400000, CRC(cbbdc6fa) SHA1(06abb738cf198804248ecfc92adea38f7f86f612) )
	ROM_LOAD( "263-v3nd.v3", 0x800000, 0x400000, CRC(c4f1a3cc) SHA1(109e8db93875e1b1f3db293d1756b2bbebe63a28) )
	ROM_LOAD( "263-v4nd.v4", 0xC00000, 0x400000, CRC(40126a0a) SHA1(4234e0f4d9a9dc486d7af1eec91a17840a57976d) )
...
ROM_START( mslug5nd )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
    ROM_LOAD16_WORD_SWAP( "268-p1n.p1", 0x000000, 0x600000, CRC(975eb06a) SHA1(d3d4824a0b9f077c6503959da54edb53820e6a8d) )
...
ROM_START( nitdd )
	...
	NEO_SFIX_128K( "260-s1d.s1", CRC(dd3bf47c) SHA1(881271caee6508b8be51bf1b59c8f1e58e08e551) )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "260-c1d.c1", 0x0000000, 0x800000, CRC(f3ff4953) SHA1(0e54548387f3056088e89086a30da05935d08b24) )
	ROM_LOAD16_BYTE( "260-c2d.c2", 0x0000001, 0x800000, CRC(f1e49faa) SHA1(2a771e318423addd9daae3a9af200de2c70f4021) )
ROM_END
...
ROM_START( pnyaad )
	...
	NEO_SFIX_128K( "267-s1d.s1", CRC(88ffbb15) SHA1(e5b97c17167c44f6425006e939149c9fb4e6b1b2) )

	NEO_BIOS_AUDIO_512K( "267-m1d.m1", CRC(d58eaa8e) SHA1(4c4faf1da671a41b4d854790eb623a40cb35f256) )

	ROM_REGION( 0x400000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "267-m1d.v1", 0x000000, 0x400000, CRC(1ac7db71) SHA1(98ef758181da1632f9ba4aed70e8bd1f338976d7) )

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "267-c1d.c1", 0x0000000, 0x800000, CRC(75fa4f27) SHA1(05f39dc5bedfecff67a9e5bd0bb8d09d93168f58) )
	ROM_LOAD16_BYTE( "267-c2d.c2", 0x0000001, 0x800000, CRC(02345689) SHA1(d40c425e73fd8dc0b0f66bf72a79f66b3bf390e1) )
ROM_END
...
ROM_START( preisl2d )
	...
	NEO_SFIX_128K( "255-s1d.s1", CRC(666cabdc) SHA1(f37206ea84b3053f38b2263c1c228463899e425e) )
	...
	ROM_REGION( 0x3000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "255-c1d.c1", 0x0000000, 0x800000, CRC(50fd785e) SHA1(97e03925f3060df4cfa576b6d2c2000952990530) )
	ROM_LOAD16_BYTE( "255-c2d.c2", 0x0000001, 0x800000, CRC(ab913f1e) SHA1(e3413d40dc4a2240ff0302eb9eff4cc64895b6ef) )
	ROM_LOAD16_BYTE( "255-c3d.c3", 0x1000000, 0x800000, CRC(bc0ee75c) SHA1(50c01b97d5457c2c1b8df8c0c7eda69384dea78b) )
	ROM_LOAD16_BYTE( "255-c4d.c4", 0x1000001, 0x800000, CRC(29908823) SHA1(2a40263f3866c06eecc209faeea7ced6641ed918) )
	ROM_LOAD16_BYTE( "255-c5d.c5", 0x2000000, 0x800000, CRC(83c56bca) SHA1(54bec4cce628bef3b87bbd6c0339494232a9516b) )
	ROM_LOAD16_BYTE( "255-c6d.c6", 0x2000001, 0x800000, CRC(59e0e805) SHA1(0d9c9b52bb0672fe70ffbb2780a9449f6a7f0984) )
ROM_END
...
ROM_START( rotdd )
	...
	NEO_BIOS_AUDIO_128K( "264-m1d.m1", CRC(c5d36af9) SHA1(320739d0cfa6cc84455ae1f7b1f9cdab3c018933) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "264-v1d.v1", 0x000000, 0x800000, CRC(2c49f3fa) SHA1(501e8b792bc96a262058326541333738418fbbdd) )
	ROM_LOAD( "264-v2d.v2", 0x800000, 0x800000, CRC(967279da) SHA1(21e90e14f6a6d73dd049541120c36d4421e237e6) )
	...
	ROM_LOAD16_BYTE( "264-c3d.c3", 0x1000000, 0x800000, CRC(7e636d49) SHA1(1ba15ddbce8369d7232cc1da3f833f6cb68fbc10) )
	ROM_LOAD16_BYTE( "264-c4d.c4", 0x1000001, 0x800000, CRC(76892fda) SHA1(27416585973a6ec7b5721de1116c8700b38e3a4c) )
	ROM_LOAD16_BYTE( "264-c5d.c5", 0x2000000, 0x800000, CRC(469061bc) SHA1(34e60e5f93743be88bfc9e8b7656fe9faf77f8f5) )
	ROM_LOAD16_BYTE( "264-c6d.c6", 0x2000001, 0x800000, CRC(2200220a) SHA1(8379b4c89854b3cc9b4f33f4f51ab5387acd14ca) )
	ROM_LOAD16_BYTE( "264-c7d.c7", 0x3000000, 0x800000, CRC(edda4baf) SHA1(3F53EB50FD9EC9E9EE05EEE050885C07023B6D53) )
	ROM_LOAD16_BYTE( "264-c8d.c8", 0x3000001, 0x800000, CRC(82b1ba22) SHA1(B4AD715807F2C15FC06945F0BCB475C3698CF089) )
ROM_END
...
ROM_START( s1945pd )
	...
	NEO_SFIX_128K( "264-s1d.s1", CRC(121a4f94) SHA1(5f00f3c5eb6f95c16add2050157803a375bb333d) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "254-c1d.c1", 0x0000000, 0x800000, CRC(7b6902f9) SHA1(c974a3cd84fa15d5ae7c9053adbb004a9aa902cd) )
	ROM_LOAD16_BYTE( "254-c2d.c2", 0x0000001, 0x800000, CRC(51bd4252) SHA1(5a99563de1d83b7cd1d7ca7a50c71d5f30439276) )
	ROM_LOAD16_BYTE( "254-c3d.c3", 0x1000000, 0x800000, CRC(a38993e4) SHA1(0bd3bcecf17abfda7da997e348fe3b0e7a66a828) )
	ROM_LOAD16_BYTE( "254-c4d.c4", 0x1000001, 0x800000, CRC(d5696530) SHA1(15cbdaa729b8dd4d2489157d778379cfb0f79e51) )
	ROM_LOAD16_BYTE( "254-c5d.c5", 0x2000000, 0x800000, CRC(28764bd6) SHA1(21158ea89dd88abd7f73b4513b699089f7944ba5) )
	ROM_LOAD16_BYTE( "254-c6d.c6", 0x2000001, 0x800000, CRC(9931bdf1) SHA1(fa95fd8621403684e09f01a89f8df9ae2fa7de76) )
	ROM_LOAD16_BYTE( "254-c7d.c7", 0x3000000, 0x800000, CRC(6e12afcd) SHA1(ef45d9b923ec937f9c207cd50d917f0ded5b8faf) )
	ROM_LOAD16_BYTE( "254-c8d.c8", 0x3000001, 0x800000, CRC(178d4684) SHA1(3cbf379209c189ee48260a044dc2754035f57e14) )
ROM_END

ROM_START( samsh3hb )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "ss3_en-p1.p1", 0x000000, 0x100000, CRC(15e021ca) SHA1(78aba32741d2e4b5bc4c641a4166f4405ab240e2) )
	ROM_LOAD16_WORD_SWAP( "ss3-sp2.sp2", 0x100000, 0x200000, CRC(1cc2c370) SHA1(01fba8d315d684652fb506aa833fa0e8e3e350df) )
...
ROM_START( samsh5bd )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "ssv-c1d.bin", 0x0000000, 0x800000, CRC(4e7bdea1) SHA1(2376386e0e82820c0853cf39e27167f8c181980c) )
	ROM_LOAD16_BYTE( "ssv-c2d.bin", 0x0000001, 0x800000, CRC(7b444985) SHA1(1f2941f6a1bee6391002b88277edcfa7554f10f3) )
	ROM_LOAD16_BYTE( "ssv-c3d.bin", 0x1000000, 0x800000, CRC(8c709a9b) SHA1(92a03ccf08d301955b06f3323417b4f20d773428) )
	ROM_LOAD16_BYTE( "ssv-c4d.bin", 0x1000001, 0x800000, CRC(cfd53f5c) SHA1(773b03fb6faa958eddee6b001ebb619f8a8d5b30) )
	ROM_LOAD16_BYTE( "ssv-c5d.bin", 0x2000000, 0x800000, CRC(c026d318) SHA1(fec9a9309afe94f21e0f35ec992a39ce51deefc2) )
	ROM_LOAD16_BYTE( "ssv-c6d.bin", 0x2000001, 0x800000, CRC(b3d9d204) SHA1(9dbcf6c179ea3a04c8ed26416e4e91324fd1cf11) )
	ROM_LOAD16_BYTE( "ssv-c7d.bin", 0x3000000, 0x800000, CRC(fe03a025) SHA1(3a052869f6b46cffc5d1ea497b0d5f1f4d1874c2) )
	ROM_LOAD16_BYTE( "ssv-c8d.bin", 0x3000001, 0x800000, CRC(89db2d34) SHA1(cd3f1e4ef631704c1078c915135a4510891bd429) )
ROM_END
...
ROM_START( samsh5d )
	...
	NEO_SFIX_128K( "270-s1d.s1", CRC(2ad6048b) SHA1(173c8561f0633e0d6e4a9750e632f2e46766e674) )

	NEO_BIOS_AUDIO_512K( "270-m1d.m1", CRC(5218a10a) SHA1(da4968e55d4a56249d85d6742a6acffcff4ad65d) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "270-v1d.v1", 0x000000, 0x800000, CRC(809c7617) SHA1(b6b542eb4c1078016fcd78d050433dc8e3029329) )
	ROM_LOAD( "270-v2d.v2", 0x800000, 0x800000, CRC(42671607) SHA1(4fa64b5a9349e9c3d5d60806c9da4a2b6beff18a) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "270-c1d.c1", 0x0000000, 0x800000, CRC(9adec562) SHA1(069d73384dc320c38db420c8b04db86ac0b76101) )
	ROM_LOAD16_BYTE( "270-c2d.c2", 0x0000001, 0x800000, CRC(ac0309e5) SHA1(9795fb2fa9eea617ec25656cfa9cd507899ec4fe) )
	ROM_LOAD16_BYTE( "270-c3d.c3", 0x1000000, 0x800000, CRC(82db9dae) SHA1(0206e1cc2c5f0fbbc074a93add5a44f645951d0c) )
	ROM_LOAD16_BYTE( "270-c4d.c4", 0x1000001, 0x800000, CRC(f8041153) SHA1(55705c725aff949e668c24b23e2e4cdb4ecf78ae) )
	ROM_LOAD16_BYTE( "270-c5d.c5", 0x2000000, 0x800000, CRC(e689d62d) SHA1(001a59bb1bb14f263d16f8b7e977cd49e44e265a) )
	ROM_LOAD16_BYTE( "270-c6d.c6", 0x2000001, 0x800000, CRC(a993bdcf) SHA1(d15980afe6d4b33506918186a2efc3f51b2347ca) )
	ROM_LOAD16_BYTE( "270-c7d.c7", 0x3000000, 0x800000, CRC(707d56a0) SHA1(303ecc621305c8fbeece8d599f9382fe82d191ee) )
	ROM_LOAD16_BYTE( "270-c8d.c8", 0x3000001, 0x800000, CRC(f5903adc) SHA1(64f867a4e9d23302aa1e884f8fad7872ee347a86) )
ROM_END
...
ROM_START( samsh5nd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "270-p1nd.p1", 0x000000, 0x800000, CRC(7b88cbef) SHA1(9db06a9478cdcca2a0244688321db2499b0a0190) )
...
ROM_START( samsh5pf )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "273-p1.bin", 0x000000, 0x800000, CRC(e3d18d3a) SHA1(25beacc2354bb8eff5c08900b954de877d3c4776) )

	NEO_SFIX_128K( "273-s1.bin", CRC(abb3baf9) SHA1(dc8072e8757dc525d9285b77a56fdedaf4d9330d) )

	NEO_BIOS_AUDIO_128K( "273-m1.bin", CRC(654e9236) SHA1(e13a1b4b73d43008565ee419c9714a220927d0bc) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "272-v1d.v1", 0x000000, 0x800000, CRC(28d57d10) SHA1(4ee3cf7951070e0f957593ab984cc0cb334e5441) )
	ROM_LOAD( "272-v2d.v2", 0x800000, 0x800000, CRC(95fe7646) SHA1(eec1a3a4dc5b5a960735147c29b976581a660628) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "273-c1d.bin", 0x0000000, 0x800000, CRC(ec9fda8d) SHA1(acc307e864d0ba15beb78a42edfa62941394ab9f) )
	ROM_LOAD16_BYTE( "273-c2d.bin", 0x0000001, 0x800000, CRC(d2fc888d) SHA1(cffa2aed9581ac42db0672a25ae737885f4c2044) )
	ROM_LOAD16_BYTE( "273-c3d.bin", 0x1000000, 0x800000, CRC(b0ea781b) SHA1(6e336952df4ec2d203a335e024ca85b912f7fa38) )
	ROM_LOAD16_BYTE( "273-c4d.bin", 0x1000001, 0x800000, CRC(d34ac591) SHA1(dc429100fc26baaca70f6dbf9d1c4d837b85935e) )
	ROM_LOAD16_BYTE( "273-c5d.bin", 0x2000000, 0x800000, CRC(1b5c1ea2) SHA1(7741344a640945770b9c97ccb3e30155874de9e8) )
	ROM_LOAD16_BYTE( "273-c6d.bin", 0x2000001, 0x800000, CRC(deeaad58) SHA1(e718fb195af55c2df8a101cbb6b5a050c4cb14e3) )
	ROM_LOAD16_BYTE( "273-c7d.bin", 0x3000000, 0x800000, CRC(af90afc8) SHA1(96957010046ed4493e18fc45582ce7a494b8f2b2) )
	ROM_LOAD16_BYTE( "273-c8d.bin", 0x3000001, 0x800000, CRC(b14872da) SHA1(b043094f29305cdc8669feaf096ef4451778a408) )
ROM_END
...
ROM_START( sams5spd )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "272-c1d.c1", 0x0000000, 0x800000, CRC(8548097e) SHA1(99177F64039D2914FA4EBD4AFC7EB0FBF4FFE0AF) )
	ROM_LOAD16_BYTE( "272-c2d.c2", 0x0000001, 0x800000, CRC(8c1b48d0) SHA1(3F20288ED369E6276CFAEDFF7E9703D4EA1CF6F6) )
	ROM_LOAD16_BYTE( "272-c3d.c3", 0x1000000, 0x800000, CRC(96ddb28c) SHA1(7EBE5166D279C0D3EFEF65618D015B4EA13F2C49) )
	ROM_LOAD16_BYTE( "272-c4d.c4", 0x1000001, 0x800000, CRC(99ef7a0a) SHA1(9AC3EF339BC1D6E3482E0B32D40B259EC2B44FC1) )
	ROM_LOAD16_BYTE( "272-c5d.c5", 0x2000000, 0x800000, CRC(772e8b1e) SHA1(8DE4898BBD8EDE593763BFA93BBF26492492D23A) )
	ROM_LOAD16_BYTE( "272-c6d.c6", 0x2000001, 0x800000, CRC(5fff21fc) SHA1(5D0A23A41F5277AB09FD11F227BE35F1713A4B4F) )
	ROM_LOAD16_BYTE( "272-c7d.c7", 0x3000000, 0x800000, CRC(9ac56a0e) SHA1(EA4FFEC3FE2E58DF16B40FDF33E1708680010414) )
	ROM_LOAD16_BYTE( "272-c8d.c8", 0x3000001, 0x800000, CRC(cfde7aff) SHA1(25185F471DD35E5D388B75B83D8652085CD5E17D) )
ROM_END
...
ROM_START( sams5shnd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "272-p1nd.p1", 0x000000, 0x800000, CRC(2dbd32dc) SHA1(595693e1e116f96dbe6e552565a4edb06f685a67) )

	NEO_SFIX_128K( "272-s1d.s1", CRC(c297f973) SHA1(b31af6b51e7536b538cd7eb3542c631c6327e826) )

	NEO_BIOS_AUDIO_128K( "272-m1nd.m1", CRC(0b5d4d6a) SHA1(2467e06be986cba8c879412cba0388019892dbb2) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "272-v1nd.v1", 0x000000, 0x400000, CRC(4d1b252b) SHA1(e5efe408c337a2ca556e790f0fd917ba44f975e3) )
	ROM_LOAD( "272-v2nd.v2", 0x400000, 0x400000, CRC(0e46d2f8) SHA1(b8b0838124ea29f73f31e08d5cced8797cea75b1) )
	ROM_LOAD( "272-v3nd.v3", 0x800000, 0x400000, CRC(3f0f7554) SHA1(2581e297725f3b950b59e9086ac5569171da6140) )
	ROM_LOAD( "272-v4nd.v4", 0xc00000, 0x400000, CRC(ad8fabb4) SHA1(cebe3b7306e1431ebb99df13bfc2270b1d3ba1ff) )
	// fix sound crackling
...
ROM_START( sams5sond )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "272-p1s.p1", 0x000000, 0x800000, CRC(3e3961f5) SHA1(523c117da1df9ea85d29af0efa5884a87a42345e) )
...
ROM_START( sengok3d )
	...
	NEO_SFIX_128K( "261-s1d.s1", CRC(c1e27cc7) SHA1(7d38319f517059f60287a8ce393a4901719db8a9) )
	...
	ROM_REGION( 0x2000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "261-c1d.c1", 0x0000000, 0x800000, CRC(9af7cbca) SHA1(cf2fe3e5265861369f2878140ef33a6715b031aa) )
	ROM_LOAD16_BYTE( "261-c2d.c2", 0x0000001, 0x800000, CRC(2a1f874d) SHA1(26923ec0bedba56f25e6222aa107b45ccb3def7b) )
	ROM_LOAD16_BYTE( "261-c3d.c3", 0x1000000, 0x800000, CRC(5403adb5) SHA1(5614ee892e810dc49758f5985b3dc4f227e01b56) )
	ROM_LOAD16_BYTE( "261-c4d.c4", 0x1000001, 0x800000, CRC(18926df6) SHA1(a4859c9166ef7abec1f3e6af3292051a63a81f93) )
ROM_END
...
ROM_START( svcd )
	...
	NEO_SFIX_512K( "269-s1d.s1", CRC(ad184232) SHA1(6645d323d641004fa7a17e3b1e65613f398c95dd) )

	NEO_BIOS_AUDIO_128K( "269-m1d.m1", CRC(447b3123) SHA1(a09adc2c0ee2ee0f01287ceb97474a1a58093bd2) )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "269-c1d.c1", 0x0000000, 0x800000, CRC(465d473b) SHA1(0b2BE2B2657C2AE021EC91515D1D6306179751D5) )
	ROM_LOAD16_BYTE( "269-c2d.c2", 0x0000001, 0x800000, CRC(3eb28f78) SHA1(DF1B096FE95796DB1515B69F74266ED13DD9EE56) )
	ROM_LOAD16_BYTE( "269-c3d.c3", 0x1000000, 0x800000, CRC(f4d4ab2b) SHA1(A19788435173540469FE5D07429A83DDE6D701A0) )
	ROM_LOAD16_BYTE( "269-c4d.c4", 0x1000001, 0x800000, CRC(a69d523a) SHA1(98D8DAC2E40F71B5B8426D3C77476A0A20783181) )
	ROM_LOAD16_BYTE( "269-c5d.c5", 0x2000000, 0x800000, CRC(ba2a7892) SHA1(EED45E1330DCC9F610598DC53977BF3A81DD161A) )
	ROM_LOAD16_BYTE( "269-c6d.c6", 0x2000001, 0x800000, CRC(37371ca1) SHA1(8AAA1B9EA34470085D9944C9AD64CFB0FFE09859) )
	ROM_LOAD16_BYTE( "269-c7d.c7", 0x3000000, 0x800000, CRC(5595b6cc) SHA1(9d6cc70f435401355b885475ccc3864825887656) )
	ROM_LOAD16_BYTE( "269-c8d.c8", 0x3000001, 0x800000, CRC(b17dfcf9) SHA1(46af296b12831ee40355f52d2c316f609557d6df) )
ROM_END

ROM_START( svcnd ) 
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "269-p1d.p1", 0x000000, 0x600000, CRC(93855c0b) SHA1(03dd06ff5a11a37990bd0a9531beb44c63de2d91) )
...
ROM_START( svcsplusp )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "svc-p1sp.bin", 0x000000, 0x600000, CRC(f6a1df16) SHA1(9d96fcd2996b93823b8c2f7791bcc18e2fc42833) )

	NEO_SFIX_128K( "svc-s1sp.bin", CRC(0b6fd62e) SHA1(ebeb80634c91c249412f75c99be93861183d06b9) )
...
ROM_START( zupapad )
	...
	NEO_SFIX_128K( "070-s1d.s1", CRC(307967ba) SHA1(b91430d0fb08ca6e0d63ded42016fd2a5cd9728b) )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "070-c1d.c1", 0x0000000, 0x800000, CRC(65d73348) SHA1(69688bb018246fed22201c80909439ace82aa343) )
	ROM_LOAD16_BYTE( "070-c2d.c2", 0x0000001, 0x800000, CRC(c498708f) SHA1(57c7034ab62ff5bbdf986d77f42387e6f86c8c30) )
ROM_END

/*    YEAR  NAME        PARENT    MACHINE    INPUT                     INIT        MONITOR */
/* SNK Predecrypted, Decrypted And Bootleg */
GAME( 2000, bangbedd,   bangbead, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "Bang Bead (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, cthd2k3d,   kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 (hack of The King of Fighters 2001, Fully Decrypted / set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, cthd2k3da,  kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 (hack of The King of Fighters 2001, Fully Decrypted / set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, cthd2k3a,   kof2001,  cthd2k3a,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 (hack of The King of Fighters 2001, set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, ct2k3spd,   kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg (Phenixsoft)", "Crouching Tiger Hidden Dragon 2003 Super Plus (hack of The King of Fighters 2001, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, ganryud,    ganryu,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Visco", "Ganryu / Musashi Ganryuki (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garoud,     garou,    garoud,    neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "Garou - Mark of the Wolves (NGM-2530) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, garouhd,    garou,    garouhd,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "Garou - Mark of the Wolves (NGM-2530 ~ NGH-2530) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, jockygpd,   jockeygp, jckeygpd,  jockeygp, mvs_led_state,  empty_init, ROT0, "Sun Amusement / BrezzaSoft", "Jockey Grand Prix (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, kof96ep,    kof96,    kof96ep,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters '96 (bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof97pla,   kof97,    kof97pla,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters '97 Chongchu Jianghu Plus 2003 (bootleg set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof97orod,  kof97,    neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters '97 Chongchu Jianghu Plus 2003 (bootleg) (Decrypted S)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99d,     kof99,    kof99d,    neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (NGM-2510) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, kof99kd,    kof99,    neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "The King of Fighters '99 - Millennium Battle (Korean release, Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, kof2kd,     kof2000,  kof2000d,  neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "The King of Fighters 2000 (NGM-2570 ~ NGH-2570) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, kof2knd,    kof2000,  kof2000nd, neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "The King of Fighters 2000 (not encrypted) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, kof2k1d,    kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGM-2621) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, kof2k1hd,   kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Eolith / SNK", "The King of Fighters 2001 (NGH-2621) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k1pls,   kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2001 Plus (bootleg, Set 1) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k1pla,   kof2001,  kf2k1pa,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2001 Plus (bootleg, set 2) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k1plap,  kof2001,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2001 Plus (bootleg, set 2) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kof2k2d,    kof2002,  kof2002d,  neogeo,   mvs_led_state,  empty_init, ROT0, "Eolith / Playmore", "The King of Fighters 2002 (NGM-2650 ~ NGH-2650) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kof2k2nd,   kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Eolith / Playmore", "The King of Fighters 2002 (Full Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2plsd,  kof2002,  kof2002d,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, Set 1) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2plad,  kof2002,  kof2002d,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, Set 2) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2plbd,  kof2002,  kof2002d,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, Set 3) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2plcd,  kof2002,  kf2k2plsd, neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, Set 4) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2pldd,  kof2002,  kof2002d,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Plus (bootleg, Set 5) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2mpd,   kof2002,  kf2k2mpd,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus (bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2mpp,   kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus (bootleg) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2mp2d,  kof2002,  kf2k2mp2d, neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus II (bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, kf2k2mp2p,  kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus II (bootleg) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3d,    kof2003,  kof2003d,  neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGM-2710) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3bd,    kof2003,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2003 (bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3hd,   kof2003,  kof2003hd, neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "The King of Fighters 2003 (NGH-2710) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3nd,   kof2003,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "The King of Fighters 2003 (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kf2k3pd,    kof2003,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (bootleg of The King of Fighters 2003, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3upd,   kof2003,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (bootleg of The King of Fighters 2003, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kf2k4pls,   kof2k4se, kof2k4pls, neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (bootleg of The King of Fighters 2002)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kf2k4plsp,  kof2k4se, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (bootleg of The King of Fighters 2002) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 1997, kogd,       kof97,    kogd,      neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "King of Gladiator (bootleg of The King of Fighters '97 / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 1997, kogplusd,   kof97,    kogd,      neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "King of Gladiator Plus (bootleg of The King of Fighters '97 / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thd,   kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary (bootleg of The King of Fighters 2002 / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thu,   kof2002,  kf10thu,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (bootleg of The King of Fighters 2002, set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kf10thepp,  kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary Extra Plus (bootleg of The King of Fighters 2002) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kf2k5unid,  kof2002,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (bootleg of The King of Fighters 2002, set 2) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kofse2k4,   kof2k4se, kof2k4se,  neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 (bootleg of The King of Fighters 2002) (Decrypted P)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kofse2k4p,  kof2k4se, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 (bootleg of The King of Fighters 2002) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, lans2k4d,   shocktr2, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "Lansquenet 2004 (bootleg of Shock Troopers - 2nd Squad / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, matrimd,    matrim,   matrimd,   neogeo,   mvs_led_state,  empty_init, ROT0, "Noise Factory / Atlus", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (NGM-2660 ~ NGH-2660) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, matrimbd,   matrim,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, msboot,     mslug,    neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug - Super Vehicle-001 (Bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, ms3b6boot,  mslug3,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 6 (bootleg of Metal Slug 3) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, ms4boot,    mslug4,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 4 (Bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, ms5boot,    mslug5,   mslug5e,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, ms4plusd,   mslug4,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 4 Plus (Bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, ms5plusd,   mslug5,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 5 Plus (Bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, mslug3d,    mslug3,   mslug3d,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "Metal Slug 3 (NGM-2560) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, mslug3hd,   mslug3,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "Metal Slug 3 (NGH-2560) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mslug4d,    mslug4,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Mega / Playmore", "Metal Slug 4 (NGM-2630) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mslug4hd,   mslug4,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Mega / Playmore", "Metal Slug 4 (NGH-2630) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, mslug4nd,   mslug4,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Mega / Playmore", "Metal Slug 4 (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5d,    mslug5,   mslug5d,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "Metal Slug 5 (NGM-2680) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5hd,   mslug5,   mslug5d,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "Metal Slug 5 (NGH-2680) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5nd,   mslug5,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK Playmore", "Metal Slug 5 (NGH-2680) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b2,   mslug5,   mslug5e,   neogeo,   mvs_led_state,  empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, nitdd,      nitd,     neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Eleven / Gavaking",  "Nightmare in the Dark (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, pnyaad,     pnyaa,    neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Aiky", "Pochi and Nyaa (Ver 2.02) (Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, preisl2d,   preisle2, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Yumekobo / Saurus", "Prehistoric Isle 2 (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, rotdd,      rotd,     neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Evoga / Playmore", "Rage of the Dragons (NGM-2640?) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, rotdhd,     rotd,     neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Evoga / Playmore", "Rage of the Dragons (NGH-2640?) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, s1945pd,    s1945p,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Psikyo", "Strikers 1945 Plus (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2010, samsh3hb,   samsho3,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "Samurai Shodown III / Samurai Spirits - Zankurou Musouken (Enhanced, bootleg, Hack)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, samsh5bd,   samsho5,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "Samurai Shodown V / Samurai Spirits Zero (bootleg, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, samsh5d,    samsho5,  samsho5d,  neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGM-2700, set 1) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, samsh5hd,   samsho5,  samsho5d,  neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (NGH-2700) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, samsh5nd,   samsho5,  neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, samsh5pf,   samsh5sp, neobase,   neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V / Samurai Spirits Zero Perfect", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5spd,   samsh5sp, samsh5spd, neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGM-2720) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5sod,   samsh5sp, samsh5spd, neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720, 1st release, censored) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5shd,   samsh5sp, samsh5spd, neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720, 2nd release, less censored) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5sond,  samsh5sp, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720, 1st release, censored) (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5shnd,  samsh5sp, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (NGH-2720, 2nd release, less censored) (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, sengok3d,   sengoku3, neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Noise Factory / SNK",  "Sengoku 3 / Sengoku Densho 2001 (set 1) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcd,       svc,      svcd,      neogeo,   mvs_led_state,  empty_init, ROT0, "Playmore / Capcom", "SNK vs. Capcom - SVC Chaos (NGM-2690 ~ NGH-2690) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcnd,      svc,      neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "Playmore / Capcom", "SNK vs. Capcom - SVC Chaos (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcplusb,   svc,      neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg set 3)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcsplusp,  svc,      neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Super Plus (bootleg) (Predecrypted S & P)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, zupapad,    zupapa,   neo304h,   neogeo,   mvs_led_state,  empty_init, ROT0, "SNK", "Zupapa! (Decrypted)", MACHINE_SUPPORTS_SAVE )
